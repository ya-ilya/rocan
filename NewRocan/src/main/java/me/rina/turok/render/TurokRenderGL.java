...
public class TurokRenderGL {
	...
	public static void renderScissor(int x, int y, int w, int h, TurokDisplay display) {
		...
		GL11.glScissor((int) (calculatedX * display.getScalaManager().getScaleFactor()), (int) (Minecraft.getMinecraft().displayHeight - (calculatedH * display.getScalaManager().getScaleFactor())), (int) ((calculatedW - calculatedX) * display.getScalaManager().getScaleFactor()), (int) ((calculatedH - calculatedY) * display.getScalaManager().getScaleFactor()));;
	}
